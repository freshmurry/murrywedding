...
#   }
  ...
  config.web_socket_server_url = "wss://action-cable-murrywedding.herokuapp.com/cable"
  config.action_cable.allowed_request_origins = ['https://action-cable-murrywedding.herokuapp.com/cable', 'https://action-cable-murrywedding.herokuapp.com/cable' ]
